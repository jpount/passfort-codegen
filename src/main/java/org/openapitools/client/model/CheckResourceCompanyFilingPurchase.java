...
/**
 * For details refer to [Check Reference](/reference/checks/companies/purchase-company-documentation)
 */
@ApiModel(description = "For details refer to [Check Reference](/reference/checks/companies/purchase-company-documentation)")
...
public class CheckResourceCompanyFilingPurchase extends CheckResourceBase {
  /**
  ...
  public CheckResourceCompanyFilingPurchase checkType(CheckTypeEnum checkType) {
  ...
  **/
  ...
  public CheckResourceCompanyFilingPurchase sourceId(String sourceId) {
    this.sourceId = sourceId;
    return this;
  }

   /**
   * The document that you wish to purchase
   * @return sourceId
  **/
  @ApiModelProperty(value = "The document that you wish to purchase")
  ...
  public CheckResourceCompanyFilingPurchase inputData(CompanyData inputData) {
  ...
  **/
  ...
  public CheckResourceCompanyFilingPurchase outputData(CompanyData outputData) {
  ...
  **/
  ...
  public CheckResourceCompanyFilingPurchase result(ResultEnum result) {
    this.result = result;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CheckResourceCompanyFilingPurchase checkResourceCompanyFilingPurchase = (CheckResourceCompanyFilingPurchase) o;
    return Objects.equals(this.checkType, checkResourceCompanyFilingPurchase.checkType) &&
        Objects.equals(this.sourceId, checkResourceCompanyFilingPurchase.sourceId) &&
        Objects.equals(this.inputData, checkResourceCompanyFilingPurchase.inputData) &&
        Objects.equals(this.outputData, checkResourceCompanyFilingPurchase.outputData) &&
        Objects.equals(this.result, checkResourceCompanyFilingPurchase.result) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checkType, sourceId, inputData, outputData, result, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class CheckResourceCompanyFilingPurchase {\n");
